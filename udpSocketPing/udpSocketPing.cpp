...
int main()
{
    ...
    pingDestination.sin_addr.s_addr = inet_addr("192.168.1.139");
    pingDestination.sin_port = htons(PORT);

    char pingStr[] = "Here is a ping";
    if (sendto(s, pingStr, sizeof(pingStr), 0, (struct sockaddr*) &pingDestination, sizeof(pingDestination)) == SOCKET_ERROR)
    {
